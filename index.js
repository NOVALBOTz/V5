...
const vcard = 'BEGIN:VCARD\n'  // Gak Usah Di Ganti
            ...
            + 'FN: GALAXY BOT\n' //ganti nama bot lu
            + 'ORG: NOVAL AGUSTIAN;\n' //Ganti Jadi Nama Lu
            + 'TEL;type=CELL;type=VOICE;waid=6283179856921:+6283179856921\n'  //ganti nomor lu! 
            + 'END:VCARD'
prefix =''  // Ganti Aja Terserah Lu 
blocked = []   //Jangan Ganti
limitawal = 99999 //Bebas Ganti Limit
memberlimit = 1
cr = '*Herman Botz*' 

/******** OWNER NUMBER**********/
const ownerNumber = ["6283179856921@s.whatsapp.net"]   // Ganti Nomor Lu
const pacarNumber = ["62 88268319467@s.whatsapp.net"]  // Ganti Jadi Nomor Bot Lu
/************************************/
